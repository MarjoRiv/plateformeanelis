...
class Version2_00_007 extends AbstractMigration {
    ...
    public function up(Schema $schema) {
          ...
          try {
           ...
           $this->addSql('INSERT INTO `newsletter` (`id`, `newsletter`, `commentaire`, `frequence`) VALUES(4,"mlInformations","Information à ne pas louper","annuel");');
           $this->addSql('INSERT INTO `newsletter` (`id`, `newsletter`, `commentaire`, `frequence`) VALUES(5,"mlIsimaNews","Tout ce qui se passe à l\'isima","tous les 5 mois");');
          }
          try {
