...
class Version2_00_007 extends AbstractMigration {
    ...
    public function up(Schema $schema) {
          ...
          try {
           ...
           $this->addSql('INSERT INTO `newsletter` (`id`, `newsletter`, `commentaire`, `frequence`) VALUES(3,"mlEvents","Tous les événements en France","mensuel");');
           $this->addSql('INSERT INTO `newsletter` (`id`, `newsletter`, `commentaire`, `frequence`) VALUES(2,"mlEmployments","Recherche d\'emploi","mensuel");');
           $this->addSql('INSERT INTO `newsletter` (`id`, `newsletter`, `commentaire`, `frequence`) VALUES(5,"mlIsimaNews","Tout ce qui se passe à l\'isima","mensuel");');
          }
          try {
            ...
            $this->addSql('INSERT INTO `subscriber` (`user_id`, `newsletter_id`) SELECT `User`.`id`,`newsletter`.`id` FROM User INNER JOIN newsletter ON mlInformations = 1 WHERE `newsletter`.`newsletter` = "Newsletter Anelis";');
          }
