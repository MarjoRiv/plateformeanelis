...
class Image extends \Application\MainBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function setInput(\Symfony\Component\HttpFoundation\File\UploadedFile $input)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setInput', array($input));
     ...
     * {@inheritDoc}
     */
    public function imageValid(\Symfony\Component\Validator\ExecutionContextInterface $context)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'imageValid', array($context));

        return parent::imageValid($context);
    }
    ...
    public function getDefaultWebPath()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDefaultWebPath', array());
