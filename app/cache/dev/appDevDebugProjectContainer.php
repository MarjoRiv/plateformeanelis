...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'fos_elastica.finder.afsy.user' => 'getFosElastica_Finder_Afsy_UserService',
            'fos_elastica.index.afsy' => 'getFosElastica_Index_AfsyService',
            'fos_elastica.index.afsy.user' => 'getFosElastica_Index_Afsy_UserService',
            'fos_elastica.index.afsy.user.serializer.callback' => 'getFosElastica_Index_Afsy_User_Serializer_CallbackService',
            ...
            'fos_elastica.object_persister.afsy.user' => 'getFosElastica_ObjectPersister_Afsy_UserService',
            ...
            'fos_elastica.provider.afsy.user' => 'getFosElastica_Provider_Afsy_UserService',
            ...
            'sonata.admin.cotisationtype' => 'getSonata_Admin_CotisationtypeService',
            ...
            'sonata.admin.invoice' => 'getSonata_Admin_InvoiceService',
            ...
            'sonata.admin.newsletters' => 'getSonata_Admin_NewslettersService',
        ...
        $this->aliases = array(
            ...
            'fos_elastica.index' => 'fos_elastica.index.afsy',
    ...
    /**
     * Gets the 'admin.user.registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Admin\UserBundle\Form\RegistrationType A Admin\UserBundle\Form\RegistrationType instance.
     */
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventSubscriber(new \FOS\ElasticaBundle\Doctrine\Listener($this->get('fos_elastica.object_persister.afsy.user'), array(0 => 'postPersist', 1 => 'postUpdate', 2 => 'preRemove', 3 => 'postFlush'), $this->get('fos_elastica.indexable'), array('identifier' => 'id', 'indexName' => 'afsy', 'typeName' => 'User'), ''));
        $c->addEventSubscriber(new \FOS\UserBundle\Doctrine\Orm\UserListener($this));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'panelis', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Admin/UserBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Application/MainBundle/Entity'), 2 => ($this->targetDirs[3].'/src/Application/AnnuaireBundle/Entity'), 3 => ($this->targetDirs[3].'/src/Application/CotisationBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Admin\\UserBundle\\Entity');
        $c->addDriver($b, 'Application\\MainBundle\\Entity');
        $c->addDriver($b, 'Application\\AnnuaireBundle\\Entity');
        $c->addDriver($b, 'Application\\CotisationBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('AdminUserBundle' => 'Admin\\UserBundle\\Entity', 'ApplicationMainBundle' => 'Application\\MainBundle\\Entity', 'ApplicationAnnuaireBundle' => 'Application\\AnnuaireBundle\\Entity', 'ApplicationCotisationBundle' => 'Application\\CotisationBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_88066ba555252255de3048851dba11bda501b99c4d253f61a2bbf541b6849f68');
    ...
    {
        return $this->services['fos_elastica.config_manager'] = new \FOS\ElasticaBundle\Configuration\ConfigManager(array(0 => new \FOS\ElasticaBundle\Configuration\Source\ContainerSource(array('afsy' => array('elasticsearch_name' => 'afsy', 'reference' => $this->get('fos_elastica.index.afsy'), 'name' => 'afsy', 'settings' => array(), 'type_prototype' => array(), 'use_alias' => false, 'types' => array('User' => array('name' => 'User', 'mapping' => array('dynamic_templates' => array(), 'properties' => array()), 'config' => array('persistence' => array('driver' => 'orm', 'model' => 'Admin\\UserBundle\\Entity\\User', 'provider' => array('query_builder_method' => 'createQueryBuilder', 'batch_size' => 100, 'clear_object_manager' => true), 'listener' => array('insert' => true, 'update' => true, 'delete' => true, 'flush' => true, 'immediate' => false, 'logger' => false), 'finder' => array(), 'identifier' => 'id', 'elastica_to_model_transformer' => array('hydrate' => true, 'ignore_missing' => false, 'query_builder_method' => 'createQueryBuilder'), 'model_to_elastica_transformer' => array()), 'serializer' => array('groups' => array()), 'index_analyzer' => NULL, 'search_analyzer' => NULL))))))));
    }
    ...
    /**
     * Gets the 'fos_elastica.finder.afsy.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFosElastica_Finder_Afsy_UserService()
    {
        $a = new \FOS\ElasticaBundle\Doctrine\ORM\ElasticaToModelTransformer($this->get('doctrine'), 'Admin\\UserBundle\\Entity\\User', array('hydrate' => true, 'ignore_missing' => false, 'query_builder_method' => 'createQueryBuilder', 'identifier' => 'id'));
        $a->setPropertyAccessor($this->get('fos_elastica.property_accessor'));

        return $this->services['fos_elastica.finder.afsy.user'] = new \FOS\ElasticaBundle\Finder\TransformedFinder($this->get('fos_elastica.index.afsy.user'), $a);
    }

    /**
     * Gets the 'fos_elastica.index.afsy' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFosElastica_Index_AfsyService()
    {
        return $this->services['fos_elastica.index.afsy'] = $this->get('fos_elastica.client.default')->getIndex('afsy');
    }

    /**
     * Gets the 'fos_elastica.index.afsy.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFosElastica_Index_Afsy_UserService()
    {
        $this->services['fos_elastica.index.afsy.user'] = $instance = $this->get('fos_elastica.index.afsy')->getType('User');

        $instance->setSerializer(array(0 => $this->get('fos_elastica.index.afsy.user.serializer.callback'), 1 => 'serialize'));
    ...
    {
        $a = $this->get('fos_elastica.index.afsy');

        return $this->services['fos_elastica.index_manager'] = new \FOS\ElasticaBundle\Index\IndexManager(array('afsy' => $a), $a);
    }
    ...
    protected function getFosElastica_Manager_OrmService()
    {
        ...
        $instance->addEntity('Admin\\UserBundle\\Entity\\User', $this->get('fos_elastica.finder.afsy.user'));
    ...
    /**
     * Gets the 'fos_elastica.object_persister.afsy.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFosElastica_ObjectPersister_Afsy_UserService()
    {
        $a = new \FOS\ElasticaBundle\Transformer\ModelToElasticaIdentifierTransformer(array('identifier' => 'id'));
        $a->setPropertyAccessor($this->get('fos_elastica.property_accessor'));

        return $this->services['fos_elastica.object_persister.afsy.user'] = new \FOS\ElasticaBundle\Persister\ObjectSerializerPersister($this->get('fos_elastica.index.afsy.user'), $a, 'Admin\\UserBundle\\Entity\\User', array(0 => $this->get('fos_elastica.index.afsy.user.serializer.callback'), 1 => 'serialize'));
    }
    ...
    /**
     * Gets the 'fos_elastica.provider.afsy.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFosElastica_Provider_Afsy_UserService()
    {
        return $this->services['fos_elastica.provider.afsy.user'] = new \FOS\ElasticaBundle\Doctrine\ORM\Provider($this->get('fos_elastica.object_persister.afsy.user'), $this->get('fos_elastica.indexable'), 'Admin\\UserBundle\\Entity\\User', array('query_builder_method' => 'createQueryBuilder', 'batch_size' => 100, 'clear_object_manager' => true, 'indexName' => 'afsy', 'typeName' => 'User'), $this->get('doctrine'));
    }
    ...
    protected function getFosElastica_ProviderRegistryService()
    {
        ...
        $instance->addProvider('afsy', 'User', 'fos_elastica.provider.afsy.user');
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('noreply@anelis.org' => 'ANELIS'), 'resetting' => array('noreply@anelis.org' => 'ANELIS'))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $p = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), '-729fkx[:`[@_2M|NH2MGRV-{6vh+tC`UAa(8pXXG1kQ}i;82m/E[Z:s|Z/)jJ5>', 'main', array('name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
        ...
        $r->setOptions(array('login_path' => 'fos_user_security_login', 'always_use_default_target_path' => true, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    /**
     * Gets the 'sonata.admin.cotisation' service.
     *
     * @return \Application\CotisationBundle\Admin\CotisationAdmin A Application\CotisationBundle\Admin\CotisationAdmin instance.
     */
    ...
    /**
     * Gets the 'sonata.admin.cotisationtype' service.
     *
     * @return \Application\CotisationBundle\Admin\TypeCotisationAdmin A Application\CotisationBundle\Admin\TypeCotisationAdmin instance.
     */
    protected function getSonata_Admin_CotisationtypeService()
    {
        $instance = new \Application\CotisationBundle\Admin\TypeCotisationAdmin('sonata.admin.cotisationtype', 'Application\\CotisationBundle\\Entity\\TypeCotisation', 'SonataAdminBundle:CRUD');
        ...
        $instance->setRouteBuilder($this->get('sonata.admin.route.path_info'));
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setLabel('Types de Cotisations');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataAdminBundle:Core:user_block.html.twig', 'add_block' => 'SonataAdminBundle:Core:add_block.html.twig', 'layout' => 'SonataAdminBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'filter' => 'SonataAdminBundle:Form:filter_admin_fields.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'show_compare' => 'SonataAdminBundle:CRUD:show_compare.html.twig', 'edit' => 'SonataAdminBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision_timestamp' => 'SonataAdminBundle:CRUD:history_revision_timestamp.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'SonataAdminBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig', 'tab_menu_template' => 'SonataAdminBundle:Core:tab_menu_template.html.twig', 'search' => 'SonataAdminBundle:Core:search.html.twig', 'search_result_block' => 'SonataAdminBundle:Block:block_search_result.html.twig'));
        $instance->setSecurityInformation(array());
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.admin.invoice' service.
     *
     * @return \Application\CotisationBundle\Admin\InvoiceAdmin A Application\CotisationBundle\Admin\InvoiceAdmin instance.
     */
    protected function getSonata_Admin_InvoiceService()
    {
        $instance = new \Application\CotisationBundle\Admin\InvoiceAdmin('sonata.admin.invoice', 'Application\\CotisationBundle\\Entity\\Invoice', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata.admin.newsletters' service.
     *
     * @return \Admin\UserBundle\Admin\NewslettersAdmin A Admin\UserBundle\Admin\NewslettersAdmin instance.
     */
    protected function getSonata_Admin_NewslettersService()
    {
        $instance = new \Admin\UserBundle\Admin\NewslettersAdmin('sonata.admin.newsletters', 'Admin\\UserBundle\\Entity\\Newsletters', 'SonataAdminBundle:CRUD');
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.admin.user', 1 => 'sonata.admin.newsletters', 2 => 'sonata.admin.cotisationtype', 3 => 'sonata.admin.cotisation', 4 => 'sonata.admin.invoice'));
        $instance->setAdminGroups(array('Content' => array('label' => 'Content', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.admin.user', 1 => 'sonata.admin.newsletters', 2 => 'sonata.admin.cotisationtype', 3 => 'sonata.admin.cotisation', 4 => 'sonata.admin.invoice'))));
        $instance->setAdminClasses(array('Admin\\UserBundle\\Entity\\User' => array(0 => 'sonata.admin.user'), 'Admin\\UserBundle\\Entity\\Newsletters' => array(0 => 'sonata.admin.newsletters'), 'Application\\CotisationBundle\\Entity\\TypeCotisation' => array(0 => 'sonata.admin.cotisationtype'), 'Application\\CotisationBundle\\Entity\\Cotisation' => array(0 => 'sonata.admin.cotisation'), 'Application\\CotisationBundle\\Entity\\Invoice' => array(0 => 'sonata.admin.invoice')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.admin.user', 1 => 'sonata.admin.newsletters', 2 => 'sonata.admin.cotisationtype', 3 => 'sonata.admin.cotisation', 4 => 'sonata.admin.invoice'), $this);
    }
     ...
     *
     * @return \Admin\UserBundle\Admin\UserAdmin A Admin\UserBundle\Admin\UserAdmin instance.
     */
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Admin/UserBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Application/MainBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Application/AnnuaireBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Application/CotisationBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
    ...
    /**
     * Gets the 'fos_elastica.index.afsy.user.serializer.callback' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFosElastica_Index_Afsy_User_Serializer_CallbackService()
    {
        $this->services['fos_elastica.index.afsy.user.serializer.callback'] = $instance = new \FOS\ElasticaBundle\Serializer\Callback();
